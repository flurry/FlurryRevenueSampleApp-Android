...
class BillingRepository private constructor(private val application: Application) :
    ...
    private fun logPayment(purchase: Purchase) {
        ...
        params["purchase_time"] = purchase.purchaseTime.toString()
        params["purchase_token"] = purchase.purchaseToken
        params["signature"] = purchase.signature
        params["purchase_state"] = purchase.purchaseState.toString()
